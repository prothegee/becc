...
INLNSTTC std::string scylladb_auth_mode_to_string(const scylladb_auth_mode_e& auth_mode_enum)
{
    ...
    {
        case SCYLLADB_AUTH_MODE_ALLOW_ALL_AUTHENTICATOR: { result = SCYLLADB_AUTH_MODE_ALLOW_ALL_AUTHENTICATOR_HINT; } break;
        case SCYLLADB_AUTH_MODE_PASSWORD_AUTHENTICATOR: { result = SCYLLADB_AUTH_MODE_PASSWORD_AUTHENTICATOR_HINT; } break;
        case SCYLLADB_AUTH_MODE_COM_SCYLLADB_AUTH_TRANSITIONAL_AUTHENTICATOR: { result = SCYLLADB_AUTH_MODE_COM_SCYLLADB_AUTH_TRANSITIONAL_AUTHENTICATOR_HINT; } break;
        default: { result = SCYLLADB_AUTH_MODE_UNDEFINED_HINT; } break;
    }
...
INLNSTTC scylladb_auth_mode_e scylladb_auth_mode_to_enum(const std::string& auth_mode_string)
{
    ...
    if (auth_mode_string == SCYLLADB_AUTH_MODE_ALLOW_ALL_AUTHENTICATOR_HINT) { return SCYLLADB_AUTH_MODE_ALLOW_ALL_AUTHENTICATOR; }
    if (auth_mode_string == SCYLLADB_AUTH_MODE_PASSWORD_AUTHENTICATOR_HINT) { return SCYLLADB_AUTH_MODE_PASSWORD_AUTHENTICATOR; }
    if (auth_mode_string == SCYLLADB_AUTH_MODE_COM_SCYLLADB_AUTH_TRANSITIONAL_AUTHENTICATOR_HINT) { return SCYLLADB_AUTH_MODE_COM_SCYLLADB_AUTH_TRANSITIONAL_AUTHENTICATOR; }
